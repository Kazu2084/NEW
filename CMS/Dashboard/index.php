            ...
            <ul class="nav flex-column" id="aside-nav-ul">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        ...
                        <span style="font-size: 18px;" class="ms-2">Leave</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        ...
                        <span style="font-size: 18px;" class="ms-2">Complaint</span>
                        <span class="aside-badge ms-2">40</span>
                    </a>
                </li>
                <li class="nav-item aside-dropdown">
                    <a class="nav-link position-relative" data-bs-toggle="collapse" href="#collapsePricing"
                        role="button" aria-expanded="false" aria-controls="collapseExample">
                        <i class="far fa-money-bill-alt" style="font-size: 16px;"></i>
                        <span style="font-size: 18px;" class="ms-2">Fee</span>
                    ...
                    <ul class="collapse list-unstyled aside-dropdown-menu" id="collapsePricing">
                        <li><a style="font-size: 16px;" class="nav-link" href="http://localhost/CMS/Fee/index.php">Pay Fee</a></li>
                        <li><a style="font-size: 16px;"class="nav-link" href="#">View Receipt</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
